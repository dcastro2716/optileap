...
import avatar from "assets/img/faces/User_Circle.png";
...
function Sidebar(props) {
  ...
  const activeRoute = (routeName) => {
    return props.router.pathname.endsWith(routeName) ? "active" : "";
  };
              ...
              */}
              <ListItem className={classes.collapseItem}>
                ...
                >
                  ...
                  <ListItemText
                    primary={rtlActive ? "إعدادات" : "Salir"}
                    disableTypography={true}
                    className={collapseItemText}
                  />
                </a>
